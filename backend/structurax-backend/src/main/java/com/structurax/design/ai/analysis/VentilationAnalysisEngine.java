...
@Component
public class VentilationAnalysisEngine {

    private final AIConstraintEngine constraintEngine;

    public VentilationAnalysisEngine(
            AIConstraintEngine constraintEngine) {

        this.constraintEngine = constraintEngine;
    }

    public double calculateVentilationScore(
        ...
        for (Room room : rooms) {
            ...
            totalScore += calculateRoomVentilation(
                    room,
                    windows);
    ...
    private double calculateRoomVentilation(
        ...
        if (constraintEngine.roomRequiresVentilation(
                room.getRoomType())) {
